...
const headerSearchIcon = document.querySelector('.header__top-item .header__search-icon');
const headerCloseSearchButton = document.querySelector('.header__search-bar .header__search-bar__back-button') 
